      ...
      <div className='grid grid-cols-12 gap-4'>
        ...
        <div className='col-span-12 lg:col-span-4 flex flex-col items-center space-y-4 py-6'>
          ...
          <div className='w-[90%] px-4 py-2 bg-primary-bg rounded-lg mt-6'>
            ...
            <div className='mt-4'>
              <a
                href="https://hcmute-consultant-server-production.up.railway.app/oauth2/authorize/google?redirect_uri=https://hcmute-consultant-client.vercel.app//oauth2/redirect"
