              ...
              <form onSubmit={onSubmit}>
                ...
                <div className='grid grid-cols-12 mt-8 text-left text-sm'>
                  <div className='col-span-12 grid grid-cols-12 text-center'>
                    ...
                    <div className='col-span-2'>1 = Rất không hài lòng</div>
                    <div className='col-span-2'>2 = Không hài lòng</div>
                    <div className='col-span-2'>3 = Bình thường</div>
                    <div className='col-span-2'>4 = Hài lòng</div>
                    <div className='col-span-2'>5 = Rất không hài lòng</div>
                  </div>
